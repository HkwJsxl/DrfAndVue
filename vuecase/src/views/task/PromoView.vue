  ...
  <div style="margin: 24px">
    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix" style="margin-bottom: 10px">
        ...
        <el-button style="float: right;" type="primary" size="medium" @click="showDrawerVisible">
          <i class="el-icon-circle-plus-outline"></i> 新建推广
        </el-button>
      </div>
      ...
      <el-table :data="tableData" border style="width: 100%" size="medium">
        ...
        <el-table-column prop="status" label="二维码">
          <template slot-scope="scope">
            <el-popover placement="right" width="400" trigger="hover">
              <el-image :src="scope.row.imgPath" fit="fill"></el-image>
              <el-image slot="reference" style="width: 100px; height: 100px" :src="scope.row.imgPath"
                        fit="fill"></el-image>
            </el-popover>
          </template>
        </el-table-column>
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            <el-button @click="searchEditClick(scope.row)" type="text">编辑</el-button>
    ...
    <el-drawer title="抽屉" :visible.sync="drawerVisible" :direction="direction" :before-close="drawerClose">
      <div style="margin: 24px">
        <el-form label-position="left" label-width="80px" :model="returnForm">
          ...
          <el-form-item>
            <el-button type="primary" @click="drawerVisible=false">新 建</el-button>
          </el-form-item>
        </el-form>
      </div>
    </el-drawer>
